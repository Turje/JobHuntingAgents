...
## Input
- Company profiles from ResearchAgent (tech stack, culture, ML use cases)
...
- "emphasis_areas": list of skill areas to highlight (e.g., "computer vision", "real-time ML", "NLP")
...
- emphasis_areas must be derived from the company's actual tech stack and ML use cases, not guessed
